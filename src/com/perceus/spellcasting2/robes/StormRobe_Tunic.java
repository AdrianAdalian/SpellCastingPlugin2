...
public class StormRobe_Tunic
{
	...
	public static void Init() 
	{
		...
		ItemUtils.applyName(final_item, "§r§fTunic of §dStorm§f");
		ItemUtils.applyLore(final_item,"§r§fElement: §dStorm§f.","§r§fA leather tunic infused with §dStorm§f energy.","§r§fWhile all pieces of the Storm Robe set","§r§fare worn, grants Lv1 damage increase.","§r§f+25 §9mana§f regen/s.");
	...
	public static void Register()
	{
		...
		NamespacedKey key = new NamespacedKey(Eden.getInstance(), "stormrobe_tunic");
