...
public class WaterRobe_Hat
{
	...
	public static void Init() 
	{
		...
		ItemUtils.applyName(final_item, "§r§fHat of §9Water§f");
		ItemUtils.applyLore(final_item,"§r§fElement: §9Water§f.","§r§fA leather hat infused with §9Water§f energy.","§r§fWhile all pieces of the Water Robe set","§r§fare worn, grants water breathing.","§r§f+25 §9mana§f regen/s.");
	...
	public static void Register()
	{
		...
		NamespacedKey key = new NamespacedKey(Eden.getInstance(), "waterrobe_hat");
