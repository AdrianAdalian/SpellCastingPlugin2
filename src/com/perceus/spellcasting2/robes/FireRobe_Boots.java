...
public class FireRobe_Boots
{
	...
	public static void Init() 
	{
		...
		ItemUtils.applyLore(final_item,"§r§fElement: §cFire§f.","§r§fLeather boots infused with §cFire§f energy.","§r§fWhile all pieces of the Fire Robe set","§r§fare worn, grants total fire immunity.","§r§f+25 §9mana§f regen/s.");
