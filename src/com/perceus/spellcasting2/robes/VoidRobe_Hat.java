...
public class VoidRobe_Hat
{
	...
	public static void Init() 
	{
		...
		ItemUtils.applyName(final_item, "§r§fHat of §r§3§lVOID§r§f");
		ItemUtils.applyLore(final_item,"§r§fElement: §r§3§lVOID§r§f.","§r§fA leather hat infused with §r§3§lVOID§r§f energy.","§r§fWhile all pieces of the Void Robe set","§r§fare worn, grants slow falling.","§r§f+25 §9mana§f regen/s.");
	...
	public static void Register()
	{
		...
		NamespacedKey key = new NamespacedKey(Eden.getInstance(), "voidrobe_hat");
