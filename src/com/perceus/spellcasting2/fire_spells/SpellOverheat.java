...
public class SpellOverheat extends BaseSpellCapsule
{
	...
	{
		super(Material.ENCHANTED_BOOK, "§r§fTome: Overheat", "SpellOverheat", 200, true, "§r§fElement: §r§cFire§r§f.","§r§fSpell Type: §cOffensive§f §dAOE§f.","§r§fSet all targets within a small radius ablaze.","§r§fDeals 10 hearts of §r§cdamage§r§f over 16 seconds to each target.","§r§fRange: 15 meters.","§r§fMana cost: 200 §r§9mana§r§f.");
	}
