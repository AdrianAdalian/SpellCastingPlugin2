...
public class SpellEruption extends BaseSpellCapsule
{
	...
	{
		super(Material.ENCHANTED_BOOK, "§r§fTome: Eruption", "SpellEruption", 800, true, "§r§fElement: §r§cFire§r§f.","§r§fSpell Type: §cOffensive§f §dAOE§f.","§r§fEmit a surge of §r§cFire§r§f energy around the caster,","§r§fpriming all nearby targets within range.","§r§fThose effected will explode after a short duration.","§r§fDelay: 5 seconds.","§r§fRange: 30 meters.","§r§fMana cost: 800 §r§9mana§r§f.");
