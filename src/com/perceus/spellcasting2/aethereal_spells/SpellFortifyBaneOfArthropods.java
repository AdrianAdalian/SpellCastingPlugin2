...
public class SpellFortifyBaneOfArthropods extends BaseSpellCapsule
{
	...
	{
		super(Material.ENCHANTED_BOOK,"§r§f§ko§r§bAethereal Tome§f: Fortify Bane of Arthropods§r§f§ko§r", "SpellFortifyBaneOfArthropods", 1000, false, "§r§fElement: §r§b§l§oAethereal§r§f.","§r§fA spelltome containing §r§b§l§oAethereal§r§f energy.","§r§fAn incantation is written within that allows","§r§fthe caster to enchant items.","§r§fEnchant offhand applicable item with tier one spider bane.","§r§fIf the current item is already enchanted, 'level it up'.","§r§fMana cost: 1000 §r§9mana§r§f.");
