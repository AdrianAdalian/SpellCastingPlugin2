...
public class SpellFortifyMending extends BaseSpellCapsule
{
	...
	{
		super(Material.ENCHANTED_BOOK, "§r§f§ko§r§bAethereal Tome§f: Fortify Mending§r§f§ko§r", "SpellFortifyMending", 1000, false, "§r§fElement: §r§b§l§oAethereal§r§f.","§r§fA spelltome containing §r§b§l§oAethereal§r§f energy.","§r§fAn incantation is written within that allows","§r§fthe caster to enchant items.","§r§fEnchant offhand applicable item with mending.","§r§fMana cost: 1000 §r§9mana§r§f.");
	}
