...
public class ArchmageRobe_Tunic
{
	...
	public static void Init() 
	{
		...
		ItemUtils.applyName(final_item, "§r§fArchmage's Tunic");
		ItemUtils.applyLore(final_item,"§r§fElement: §bE§ft§bh§fe§br.","§r§fA leather tunic infused with §bE§ft§bh§fe§br energy.","§r§fWhile all pieces of the Archmage's robe set","§r§fare worn, grants +150 §9mana§f regen/s.");
	...
	public static void Register()
	{
		...
		NamespacedKey key = new NamespacedKey(Eden.getInstance(), "archmagerobe_tunic");
