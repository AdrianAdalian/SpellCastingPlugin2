...
public class LivingArmor_DragonScaleBoots extends BaseSpellCapsule
{
	...
	{
		super(Material.NETHERITE_BOOTS, "§r§b§lLiving §r§eArmor§f: Dragonscale Chestplate", "LivingArmor_DragonScaleBoots", 0, false, "§r§fElement: §r§6§lConstruct§r§f.",
	...
	private static void bootsRunnable(PlayerInteractEvent event, Player player) 
	{
