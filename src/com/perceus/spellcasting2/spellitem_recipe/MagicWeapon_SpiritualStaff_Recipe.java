...
public class MagicWeapon_SpiritualStaff_Recipe
{
	static ItemStack final_item;
	
	public static void Init() 
	{
		BaseSpellCapsule sStaff = new MagicWeapon_SpiritualStaff();
		final_item = sStaff.generate();
	}
	
	public static void Register()
	{
		
		NamespacedKey key = new NamespacedKey(Eden.getInstance(), "magic_weapon_spiritual_staff");
