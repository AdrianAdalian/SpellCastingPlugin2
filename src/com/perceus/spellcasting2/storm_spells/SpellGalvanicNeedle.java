...
public class SpellGalvanicNeedle extends BaseSpellCapsule
{
	...
	{
		super(Material.AMETHYST_SHARD, "§r§7§ko§r§7§lSpell: §r§fGalvanic Needle§r§7§ko§r", "SpellGalvanicNeedle", 125, true, true, "§r§fElement: §r§dStorm§r§f.","§r§fSpell Type: §cOffensive§f.","§r§fFire an electrified crystal shard","§r§fthat acts like a lightning rod.","§r§fDeals 1 heart of §r§cdamage§r§f from crystal strike,","§r§fthen summons a bolt of lightning.","§r§fMana cost: 125 §r§9mana§r§f.");
	}
