...
public class SpellProtectOther extends BaseSpellCapsule
{
	...
	{
		super(Material.ENCHANTED_BOOK, "§r§f§ko§r§fTome: Protect Other§r§f§ko§r", "SpellProtectOther", 100, false, "§r§fElement: §r§f§o§lHoly§r§f.","§r§fSpell Type: §aSupport§f §6Buff§f.","§r§fProtect the target by raising a barrier around them.","§r§fApply a full bar of absorption to target player.","§r§fDuration: 1 minute.","§r§fRange: 10 meters.","§r§fMana cost: 100 §r§9mana§r§f.");
	}
