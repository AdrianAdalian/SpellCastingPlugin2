...
public class SpellLivingRecall extends BaseSpellCapsule
{
	...
	{
		super(Material.ENCHANTED_BOOK, "§r§fTome: Recall", "SpellLivingRecall", 100, false, "§r§fElement: §r§f§o§lHoly§r§f.","§r§fSpell Type: §bUtility§f.","§r§fA spelltome with an incantation within that allows","§r§fthe caster to recall to their spawnpoint.","§r§fMana cost: 100 §r§9mana§r§f.");
