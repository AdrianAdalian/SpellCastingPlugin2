...
public class SpellMendingWater extends BaseSpellCapsule
{
	...
	{
		super(Material.LAPIS_LAZULI, "§r§7§ko§r§7§lSpell: §r§fMending Water§r§7§ko§r", "SpellMendingWater", 250, true, true, "§r§fElement: §r§9Water§r§f.","§r§fSpell Type: §bUtility§f.","§r§fThe caster emits a mending current of §r§9Water§r§f","§r§fto any damaged item in their left hand,","§r§frestoring it to its maximum durability.","§r§fMana cost: 250 §r§9mana§r§f.");
	}
