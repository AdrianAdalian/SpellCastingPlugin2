...
public class SpellCreateGoat extends BaseSpellCapsule
{

	public SpellCreateGoat()
	{
		super(Material.END_CRYSTAL, "§r§f§ko§r§e§lRune§f: Materialize Goat§r§f§ko§r", "SpellCreateGoat", 0, false, "§r§fElement: §r§eAncient§r§f.","§r§fAn unstable mass of §r§eAncient§r§f energy that allows","§r§fthe caster to summon living organisms.","§r§fThis rune will summon a Goat on target block.","§r§fThe rune will be consumed upon use.");
	}
	...
	public boolean cast(PlayerInteractEvent event)
	{
		...
		newloc.getWorld().spawnEntity(newloc, EntityType.GOAT);
