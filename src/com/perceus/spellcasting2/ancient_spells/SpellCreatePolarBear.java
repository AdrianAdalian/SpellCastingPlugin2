...
public class SpellCreatePolarBear extends BaseSpellCapsule
{

	public SpellCreatePolarBear()
	{
		super(Material.END_CRYSTAL, "§r§f§ko§r§e§lRune§f: Materialize Polar Bear§r§f§ko§r", "SpellCreatePolarBear", 0, false, "§r§fElement: §r§eAncient§r§f.","§r§fSpell Type: §bUtility§f.","§r§fAn unstable mass of §r§eAncient§r§f energy that allows","§r§fthe caster to summon living organisms.","§r§fThis rune will summon a Polar Bear on target block.","§r§fThe rune will be consumed upon use.");
	}
	...
	public boolean cast(PlayerInteractEvent event)
	{
		...
		newloc.getWorld().spawnEntity(newloc, EntityType.POLAR_BEAR);
