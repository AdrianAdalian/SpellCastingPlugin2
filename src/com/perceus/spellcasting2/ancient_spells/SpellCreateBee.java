...
public class SpellCreateBee extends BaseSpellCapsule
{

	public SpellCreateBee()
	{
		super(Material.END_CRYSTAL, "§r§f§ko§r§e§lRune§f: Materialize Bee§r§f§ko§r", "SpellCreateBee", 0, false, "§r§fElement: §r§eAncient§r§f.","§r§fAn unstable mass of §r§eAncient§r§f energy that allows","§r§fthe caster to summon living organisms.","§r§fThis rune will summon a Bee on target block.","§r§fThe rune will be consumed upon use.");
	}
	...
	public boolean cast(PlayerInteractEvent event)
	{
		...
		newloc.getWorld().spawnEntity(newloc, EntityType.BEE);
