...
public class SpellCreatePillager extends BaseSpellCapsule
{

	public SpellCreatePillager()
	{
		super(Material.END_CRYSTAL, "§r§f§ko§r§4Corrupted §r§e§lRune§f: Materialize Pillager§r§f§ko§r", "SpellCreatePillager", 0, false, "§r§fElement: §r§eAncient§r§f.","§r§fSpell Type: §bUtility§f.","§r§fA corrupted mass of §r§eAncient§r§f energy that allows","§r§fthe caster to summon nonliving organisms.","§r§fThis rune will summon a Pillager on target block.","§r§fThe rune will be consumed upon use.");
	}
	...
	public boolean cast(PlayerInteractEvent event)
	{
		...
		newloc.getWorld().spawnEntity(newloc, EntityType.PILLAGER);
