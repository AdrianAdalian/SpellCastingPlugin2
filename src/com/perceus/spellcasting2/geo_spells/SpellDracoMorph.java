...
public class SpellDracoMorph extends BaseSpellCapsule
{
	...
	public boolean cast(PlayerInteractEvent event)
	{
		if (!event.getAction().equals(Action.RIGHT_CLICK_AIR))
		{
		 ...
		 event.getPlayer().addPotionEffect(new PotionEffect(PotionEffectType.DAMAGE_RESISTANCE, 1200, 2));
		 event.getPlayer().addPotionEffect(new PotionEffect(PotionEffectType.SLOW, 1200, 2));
