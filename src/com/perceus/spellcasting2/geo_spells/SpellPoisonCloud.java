...
public class SpellPoisonCloud extends BaseSpellCapsule
{
	...
	{
		super(Material.SLIME_BALL, "§r§7§ko§r§7§lSpell: §r§fPoison Cloud§r§7§ko§r", "SpellPoisonCloud", 150, true, true, "§r§fElement: §r§6Geo§r§f.","§r§fEmits a cloud of poison around the caster.","§r§fDeals 4 hearts of §r§cdamage§r§f over 10 seconds.","§r§fRange: 15 meters.","§r§fMana cost: 150 §r§9mana§r§f.");
	}
