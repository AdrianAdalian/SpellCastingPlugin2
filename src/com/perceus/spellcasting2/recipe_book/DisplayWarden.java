...
public class DisplayWarden extends SurfaceGui
{

	public DisplayWarden()
	{
		super(54, "Materialize Warden Recipe", DefaultClickAction.CANCEL, InventoryAction.PICKUP_ALL, InventoryAction.PICKUP_HALF);
	}
	...
	public void init(HumanEntity player, InventoryView arg1)
	{
		...
		this.updateSingleComponent(player, 21, SimpleComponentBuilder.build(Material.ECHO_SHARD, "", (event) -> 
		{

		}));
		
		this.updateSingleComponent(player, 24, SimpleComponentBuilder.build(Material.END_CRYSTAL, "§r§f§ko§r§e§lAncient Rune§f: Materialize Warden§r§f§ko§r", (event) -> 
		{

		}));
		
		this.updateSingleComponent(player, 29, SimpleComponentBuilder.build(Material.SCULK_CATALYST, "", (event) -> 
		{
