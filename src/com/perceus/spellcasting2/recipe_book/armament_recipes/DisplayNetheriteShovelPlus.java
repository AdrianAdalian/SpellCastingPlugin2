...
public class DisplayNetheriteShovelPlus extends SurfaceGui
{

	public DisplayNetheriteShovelPlus()
	{
		super(54, "Netherite Shovel+ Recipe", DefaultClickAction.CANCEL, InventoryAction.PICKUP_ALL, InventoryAction.PICKUP_HALF);
	}
	...
	public void init(HumanEntity player, InventoryView arg1)
	{
		...
		this.updateSingleComponent(player, 20, SimpleComponentBuilder.build(Material.NETHERITE_SHOVEL, "", (event) -> 
		{
		...
		this.updateSingleComponent(player, 24, SimpleComponentBuilder.build(Material.NETHERITE_SHOVEL, "§r§fMagic Tool: Netherite Shovel§e+", (event) -> 
		{
