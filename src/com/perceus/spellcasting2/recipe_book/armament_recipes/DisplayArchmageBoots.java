...
public class DisplayArchmageBoots extends SurfaceGui
{

	public DisplayArchmageBoots()
	{
		super(54, "Archmage's Boots Recipe", DefaultClickAction.CANCEL, InventoryAction.PICKUP_ALL, InventoryAction.PICKUP_HALF);
	}
	...
	public void init(HumanEntity player, InventoryView arg1)
	{
		...
		this.updateSingleComponent(player, 24, SimpleComponentBuilder.build(Material.LEATHER_BOOTS, "§r§fArchmage's Hat", (event) -> 
		{
