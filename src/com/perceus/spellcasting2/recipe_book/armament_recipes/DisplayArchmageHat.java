...
public class DisplayArchmageHat extends SurfaceGui
{

	public DisplayArchmageHat()
	{
		super(54, "Archmage's Hat Recipe", DefaultClickAction.CANCEL, InventoryAction.PICKUP_ALL, InventoryAction.PICKUP_HALF);
	}
	...
	public void init(HumanEntity player, InventoryView arg1)
	{
		...
		this.updateSingleComponent(player, 24, SimpleComponentBuilder.build(Material.LEATHER_HELMET, "§r§fArchmage's Hat", (event) -> 
		{
