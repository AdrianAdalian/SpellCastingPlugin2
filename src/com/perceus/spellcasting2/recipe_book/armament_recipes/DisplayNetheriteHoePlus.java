...
public class DisplayNetheriteHoePlus extends SurfaceGui
{

	public DisplayNetheriteHoePlus()
	{
		super(54, "Netherite Hoe+ Recipe", DefaultClickAction.CANCEL, InventoryAction.PICKUP_ALL, InventoryAction.PICKUP_HALF);
	}
	...
	public void init(HumanEntity player, InventoryView arg1)
	{
		...
		this.updateSingleComponent(player, 20, SimpleComponentBuilder.build(Material.NETHERITE_HOE, "", (event) -> 
		{
		...
		this.updateSingleComponent(player, 24, SimpleComponentBuilder.build(Material.NETHERITE_HOE, "§r§fMagic Tool: Netherite Hoe§e+", (event) -> 
		{

		}));
		
		this.updateSingleComponent(player, 29, SimpleComponentBuilder.build(Material.BONE, "", (event) -> 
		{
