...
public class DisplayDragonscaleHelmet extends SurfaceGui
{

	public DisplayDragonscaleHelmet()
	{
		super(54, "Dragonscale Helmet Recipe", DefaultClickAction.CANCEL, InventoryAction.PICKUP_ALL, InventoryAction.PICKUP_HALF);
	}
	...
	public void init(HumanEntity player, InventoryView arg1)
	{
		...
		this.updateSingleComponent(player, 20, SimpleComponentBuilder.build(Material.NETHERITE_HELMET, "", (event) -> 
		{
		...
		this.updateSingleComponent(player, 24, SimpleComponentBuilder.build(Material.NETHERITE_HELMET, "§r§fLiving Armor: Dragonscale Helmet", (event) -> 
		{
