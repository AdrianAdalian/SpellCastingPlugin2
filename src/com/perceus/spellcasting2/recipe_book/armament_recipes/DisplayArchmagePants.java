...
public class DisplayArchmagePants extends SurfaceGui
{

	public DisplayArchmagePants()
	{
		super(54, "Archmage's Pants Recipe", DefaultClickAction.CANCEL, InventoryAction.PICKUP_ALL, InventoryAction.PICKUP_HALF);
	}
	...
	public void init(HumanEntity player, InventoryView arg1)
	{
		...
		this.updateSingleComponent(player, 24, SimpleComponentBuilder.build(Material.LEATHER_LEGGINGS, "§r§fArchmage's Pants", (event) -> 
		{
