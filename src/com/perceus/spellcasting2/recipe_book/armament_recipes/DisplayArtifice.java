...
public class DisplayArtifice extends SurfaceGui
{

	public DisplayArtifice()
	{
		super(54, "Artifice Recipe", DefaultClickAction.CANCEL, InventoryAction.PICKUP_ALL, InventoryAction.PICKUP_HALF);
	}
	...
	public void init(HumanEntity player, InventoryView arg1)
	{
		...
		this.updateSingleComponent(player, 20, SimpleComponentBuilder.build(Material.SHIELD, "", (event) -> 
		{
		...
		this.updateSingleComponent(player, 24, SimpleComponentBuilder.build(Material.SHIELD, "§r§fArmament: Artifice", (event) -> 
		{
