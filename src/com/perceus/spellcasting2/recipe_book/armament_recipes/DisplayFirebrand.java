...
public class DisplayFirebrand extends SurfaceGui
{

	public DisplayFirebrand()
	{
		super(54, "Firebrand Recipe", DefaultClickAction.CANCEL, InventoryAction.PICKUP_ALL, InventoryAction.PICKUP_HALF);
	}
	...
	public void init(HumanEntity player, InventoryView arg1)
	{
		...
		this.updateSingleComponent(player, 20, SimpleComponentBuilder.build(Material.NETHERITE_SWORD, "", (event) -> 
		{
		...
		this.updateSingleComponent(player, 24, SimpleComponentBuilder.build(Material.NETHERITE_SWORD, "§r§fArmament: Firebrand", (event) -> 
		{
