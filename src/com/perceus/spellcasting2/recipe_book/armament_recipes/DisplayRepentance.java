...
public class DisplayRepentance extends SurfaceGui
{

	public DisplayRepentance()
	{
		super(54, "Repentance Recipe", DefaultClickAction.CANCEL, InventoryAction.PICKUP_ALL, InventoryAction.PICKUP_HALF);
	}
	...
	public void init(HumanEntity player, InventoryView arg1)
	{
		...
		this.updateSingleComponent(player, 20, SimpleComponentBuilder.build(Material.BOW, "", (event) -> 
		{
		...
		this.updateSingleComponent(player, 24, SimpleComponentBuilder.build(Material.BOW, "§r§fArmament: Repentance", (event) -> 
		{
