...
public class DisplayDragonscaleBoots extends SurfaceGui
{

	public DisplayDragonscaleBoots()
	{
		super(54, "Dragonscale Boots Recipe", DefaultClickAction.CANCEL, InventoryAction.PICKUP_ALL, InventoryAction.PICKUP_HALF);
	}
	...
	public void init(HumanEntity player, InventoryView arg1)
	{
		...
		this.updateSingleComponent(player, 20, SimpleComponentBuilder.build(Material.NETHERITE_BOOTS, "", (event) -> 
		{
		...
		this.updateSingleComponent(player, 24, SimpleComponentBuilder.build(Material.NETHERITE_BOOTS, "§r§fLiving Armor: Dragonscale Boots", (event) -> 
		{
