...
public class DisplayDragonscaleChestplate extends SurfaceGui
{

	public DisplayDragonscaleChestplate()
	{
		super(54, "Dragonscale Chestplate Recipe", DefaultClickAction.CANCEL, InventoryAction.PICKUP_ALL, InventoryAction.PICKUP_HALF);
	}
	...
	public void init(HumanEntity player, InventoryView arg1)
	{
		...
		this.updateSingleComponent(player, 20, SimpleComponentBuilder.build(Material.NETHERITE_CHESTPLATE, "", (event) -> 
		{
