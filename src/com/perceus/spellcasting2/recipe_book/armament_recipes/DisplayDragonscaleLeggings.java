...
public class DisplayDragonscaleLeggings extends SurfaceGui
{

	public DisplayDragonscaleLeggings()
	{
		super(54, "Dragonscale Leggings Recipe", DefaultClickAction.CANCEL, InventoryAction.PICKUP_ALL, InventoryAction.PICKUP_HALF);
	}
	...
	public void init(HumanEntity player, InventoryView arg1)
	{
		...
		this.updateSingleComponent(player, 20, SimpleComponentBuilder.build(Material.NETHERITE_LEGGINGS, "", (event) -> 
		{
		...
		this.updateSingleComponent(player, 24, SimpleComponentBuilder.build(Material.NETHERITE_LEGGINGS, "§r§fLiving Armor: Dragonscale Leggings", (event) -> 
		{

		}));
		
		this.updateSingleComponent(player, 29, SimpleComponentBuilder.build(Material.NETHERITE_BLOCK, "", (event) -> 
		{
