...
public class DisplayBloodCrystalPlus extends SurfaceGui
{

	public DisplayBloodCrystalPlus()
	{
	...
	public void init(HumanEntity player, InventoryView arg1)
	{
		...
		this.updateSingleComponent(player, 24, SimpleComponentBuilder.build(Material.QUARTZ, "§r§7§ko§r§7§lMagical Item: §r§fBlood Crystal§r§e+§r§7§ko§r", (event) -> 
		{
