...
public class DisplayXpCrystal extends SurfaceGui
{

	public DisplayXpCrystal()
	{
		super(54, "Xp Crystal Recipe", DefaultClickAction.CANCEL, InventoryAction.PICKUP_ALL, InventoryAction.PICKUP_HALF);
	...
	public void init(HumanEntity player, InventoryView arg1)
	{
		...
		this.updateSingleComponent(player, 21, SimpleComponentBuilder.build(Material.EMERALD, "", (event) -> 
		{

		}));
		
		this.updateSingleComponent(player, 24, SimpleComponentBuilder.build(Material.QUARTZ, "§r§7§ko§r§7§lMagical Item: §r§fXp Crystal§r§7§ko§r", (event) -> 
		{

		}));
		
		this.updateSingleComponent(player, 29, SimpleComponentBuilder.build(Material.GOLD_INGOT, "", (event) -> 
		{
