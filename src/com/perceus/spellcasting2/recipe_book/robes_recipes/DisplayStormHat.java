...
public class DisplayStormHat extends SurfaceGui
{

	public DisplayStormHat()
	{
		super(54, "Hat of Storm Recipe", DefaultClickAction.CANCEL, InventoryAction.PICKUP_ALL, InventoryAction.PICKUP_HALF);
	}
	...
	public void init(HumanEntity player, InventoryView arg1)
	{
		...
		this.updateSingleComponent(player, 20, SimpleComponentBuilder.build(Material.LEATHER_HELMET, "", (event) -> 
		{
		...
		this.updateSingleComponent(player, 24, SimpleComponentBuilder.build(Material.LEATHER_HELMET, "§r§fHat of §r§dStorm", (event) -> 
		{
