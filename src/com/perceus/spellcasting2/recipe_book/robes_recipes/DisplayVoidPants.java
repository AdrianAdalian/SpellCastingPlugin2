...
public class DisplayVoidPants extends SurfaceGui
{

	public DisplayVoidPants()
	{
		super(54, "Pants of Void Recipe", DefaultClickAction.CANCEL, InventoryAction.PICKUP_ALL, InventoryAction.PICKUP_HALF);
	}
	...
	public void init(HumanEntity player, InventoryView arg1)
	{
		...
		this.updateSingleComponent(player, 24, SimpleComponentBuilder.build(Material.LEATHER_LEGGINGS, "§r§fPants of §r§3Void", (event) -> 
		{
