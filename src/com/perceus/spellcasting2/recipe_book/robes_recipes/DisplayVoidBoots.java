...
public class DisplayVoidBoots extends SurfaceGui
{

	public DisplayVoidBoots()
	{
		super(54, "Boots of Void Recipe", DefaultClickAction.CANCEL, InventoryAction.PICKUP_ALL, InventoryAction.PICKUP_HALF);
	}
	...
	public void init(HumanEntity player, InventoryView arg1)
	{
		...
		this.updateSingleComponent(player, 21, SimpleComponentBuilder.build(Material.ENDER_PEARL, "", (event) -> 
		{

		}));
		
		this.updateSingleComponent(player, 24, SimpleComponentBuilder.build(Material.LEATHER_BOOTS, "§r§fBoots of §r§3Void", (event) -> 
		{
