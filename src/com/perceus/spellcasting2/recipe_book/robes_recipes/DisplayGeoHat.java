...
public class DisplayGeoHat extends SurfaceGui
{

	public DisplayGeoHat()
	{
		super(54, "Hat of Geo Recipe", DefaultClickAction.CANCEL, InventoryAction.PICKUP_ALL, InventoryAction.PICKUP_HALF);
	}
	...
	public void init(HumanEntity player, InventoryView arg1)
	{
		...
		this.updateSingleComponent(player, 24, SimpleComponentBuilder.build(Material.LEATHER_HELMET, "§r§fHat of §r§6Geo", (event) -> 
		{
