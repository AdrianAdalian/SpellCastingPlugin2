...
public class DisplayHolyTunic extends SurfaceGui
{

	public DisplayHolyTunic()
	{
		super(54, "Tunic of Holy Recipe", DefaultClickAction.CANCEL, InventoryAction.PICKUP_ALL, InventoryAction.PICKUP_HALF);
	}
	...
	public void init(HumanEntity player, InventoryView arg1)
	{
		...
		this.updateSingleComponent(player, 24, SimpleComponentBuilder.build(Material.LEATHER_CHESTPLATE, "§r§fTunic of Holy", (event) -> 
		{
