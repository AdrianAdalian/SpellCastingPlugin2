...
public class DisplayStormPants extends SurfaceGui
{

	public DisplayStormPants()
	{
		super(54, "Pants of Storm Recipe", DefaultClickAction.CANCEL, InventoryAction.PICKUP_ALL, InventoryAction.PICKUP_HALF);
	}
	...
	public void init(HumanEntity player, InventoryView arg1)
	{
		...
		this.updateSingleComponent(player, 24, SimpleComponentBuilder.build(Material.LEATHER_LEGGINGS, "§r§fPants of §r§dStorm", (event) -> 
		{
