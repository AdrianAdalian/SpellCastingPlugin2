...
public class DisplayGeoBoots extends SurfaceGui
{

	public DisplayGeoBoots()
	{
		super(54, "Boots of Geo Recipe", DefaultClickAction.CANCEL, InventoryAction.PICKUP_ALL, InventoryAction.PICKUP_HALF);
	}
	...
	public void init(HumanEntity player, InventoryView arg1)
	{
		...
		this.updateSingleComponent(player, 24, SimpleComponentBuilder.build(Material.LEATHER_BOOTS, "§r§fBoots of §r§6Geo", (event) -> 
		{
