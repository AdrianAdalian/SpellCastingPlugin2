...
public class DisplayUnholyTunic extends SurfaceGui
{

	public DisplayUnholyTunic()
	{
		super(54, "Tunic of Unholy Recipe", DefaultClickAction.CANCEL, InventoryAction.PICKUP_ALL, InventoryAction.PICKUP_HALF);
	}
	...
	public void init(HumanEntity player, InventoryView arg1)
	{
		...
		this.updateSingleComponent(player, 24, SimpleComponentBuilder.build(Material.LEATHER_CHESTPLATE, "§r§fTunic of §r§4Unholy", (event) -> 
		{
