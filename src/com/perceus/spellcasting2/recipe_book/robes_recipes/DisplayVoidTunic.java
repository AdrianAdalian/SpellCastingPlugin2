...
public class DisplayVoidTunic extends SurfaceGui
{

	public DisplayVoidTunic()
	{
		super(54, "Tunic of Void Recipe", DefaultClickAction.CANCEL, InventoryAction.PICKUP_ALL, InventoryAction.PICKUP_HALF);
	}
	...
	public void init(HumanEntity player, InventoryView arg1)
	{
		...
		this.updateSingleComponent(player, 24, SimpleComponentBuilder.build(Material.LEATHER_CHESTPLATE, "§r§fTunic of §r§3Void", (event) -> 
		{
