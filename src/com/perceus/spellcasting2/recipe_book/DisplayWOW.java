...
public class DisplayWOW extends SurfaceGui
{

	public DisplayWOW()
	{
		super(54, "Wand of Water Recipe", DefaultClickAction.CANCEL, InventoryAction.PICKUP_ALL, InventoryAction.PICKUP_HALF);
	...
	public void init(HumanEntity player, InventoryView arg1)
	{
		...
		this.updateSingleComponent(player, 24, SimpleComponentBuilder.build(Material.STICK, "§r§fWand of §9Water", (event) -> 
		{
