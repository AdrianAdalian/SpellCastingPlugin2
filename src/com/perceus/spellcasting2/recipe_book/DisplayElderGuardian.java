...
public class DisplayElderGuardian extends SurfaceGui
{

	public DisplayElderGuardian()
	{
		super(54, "Materialize Elder Guardian Recipe", DefaultClickAction.CANCEL, InventoryAction.PICKUP_ALL, InventoryAction.PICKUP_HALF);
	}
	...
	public void init(HumanEntity player, InventoryView arg1)
	{
		...
		this.updateSingleComponent(player, 21, SimpleComponentBuilder.build(Material.LAPIS_LAZULI, "", (event) -> 
		{

		}));
		
		this.updateSingleComponent(player, 24, SimpleComponentBuilder.build(Material.END_CRYSTAL, "§r§f§ko§r§e§lAncient Rune§f: Materialize Elder Guardian§r§f§ko§r", (event) -> 
		{

		}));
		
		this.updateSingleComponent(player, 29, SimpleComponentBuilder.build(Material.PRISMARINE_CRYSTALS, "", (event) -> 
		{

		}));
		this.updateSingleComponent(player, 30, SimpleComponentBuilder.build(Material.PRISMARINE_SHARD, "", (event) -> 
		{
