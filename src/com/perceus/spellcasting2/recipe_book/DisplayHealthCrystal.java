...
public class DisplayHealthCrystal extends SurfaceGui
{

	public DisplayHealthCrystal()
	{
		super(54, "Health Crystal Recipe", DefaultClickAction.CANCEL, InventoryAction.PICKUP_ALL, InventoryAction.PICKUP_HALF);
	...
	public void init(HumanEntity player, InventoryView arg1)
	{
		...
		this.updateSingleComponent(player, 24, SimpleComponentBuilder.build(Material.QUARTZ, "§r§7§ko§r§7§lMagical Item: §r§fHealth Crystal§r§7§ko§r", (event) -> 
		{
