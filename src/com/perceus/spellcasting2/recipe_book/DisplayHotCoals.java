...
public class DisplayHotCoals extends SurfaceGui
{

	public DisplayHotCoals()
	{
		super(54, "Hot Coals Recipe", DefaultClickAction.CANCEL, InventoryAction.PICKUP_ALL, InventoryAction.PICKUP_HALF);
	...
	public void init(HumanEntity player, InventoryView arg1)
	{
		...
		this.updateSingleComponent(player, 21, SimpleComponentBuilder.build(Material.BLAZE_POWDER, "", (event) -> 
		{

		}));
		
		this.updateSingleComponent(player, 24, SimpleComponentBuilder.build(Material.FIRE_CHARGE, "§r§7§ko§r§7§lCrafted Spell: §r§fHot Coals§r§7§ko§r", (event) -> 
		{
