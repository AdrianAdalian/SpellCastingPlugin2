...
public class DisplayWOU extends SurfaceGui
{

	public DisplayWOU()
	{
		super(54, "Wand of Unholy Recipe", DefaultClickAction.CANCEL, InventoryAction.PICKUP_ALL, InventoryAction.PICKUP_HALF);
	...
	public void init(HumanEntity player, InventoryView arg1)
	{
		...
		this.updateSingleComponent(player, 24, SimpleComponentBuilder.build(Material.STICK, "§r§fWand of §o§l§4Unholy", (event) -> 
		{
