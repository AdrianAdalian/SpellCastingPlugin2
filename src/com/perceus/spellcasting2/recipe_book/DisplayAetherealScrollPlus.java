...
public class DisplayAetherealScrollPlus extends SurfaceGui
{
	public DisplayAetherealScrollPlus()
	{
	...
	public void init(HumanEntity player, InventoryView arg1)
	{
		...
		this.updateSingleComponent(player, 24, SimpleComponentBuilder.build(Material.PAPER, "§r§7§ko§r§7§lMagical Item: §r§bAethereal Scroll§r§e+§r§7§ko§r", (event) -> 
		{
