...
public class DisplayWOV extends SurfaceGui
{

	public DisplayWOV()
	{
		super(54, "Wand of Void Recipe", DefaultClickAction.CANCEL, InventoryAction.PICKUP_ALL, InventoryAction.PICKUP_HALF);
	...
	public void init(HumanEntity player, InventoryView arg1)
	{
		...
		this.updateSingleComponent(player, 24, SimpleComponentBuilder.build(Material.STICK, "§r§fWand of §r§l§3VOID", (event) -> 
		{
