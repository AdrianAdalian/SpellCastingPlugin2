...
public class DisplayProtectivePaste extends SurfaceGui
{

	public DisplayProtectivePaste()
	{
		super(54, "Protective Paste Recipe", DefaultClickAction.CANCEL, InventoryAction.PICKUP_ALL, InventoryAction.PICKUP_HALF);
	...
	public void init(HumanEntity player, InventoryView arg1)
	{
		...
		this.updateSingleComponent(player, 20, SimpleComponentBuilder.build(Material.CLAY_BALL, "", (event) -> 
		{
			
		}));
		this.updateSingleComponent(player, 21, SimpleComponentBuilder.build(Material.PAPER, "", (event) -> 
		{

		}));
		
		this.updateSingleComponent(player, 24, SimpleComponentBuilder.build(Material.CLAY_BALL, "§r§7§ko§r§7§lCrafted Spell: §r§fProtective Paste§r§7§ko§r", (event) -> 
		{
