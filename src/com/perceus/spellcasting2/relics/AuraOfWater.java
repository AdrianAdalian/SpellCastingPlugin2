...
public class AuraOfWater extends BaseSpellCapsule
{

	public AuraOfWater()
	{
		super(Material.NAME_TAG, "§r§fAura of §9Water", "AuraOfWater", 0, true, "§r§fElement: §aPri§bmor§edi§6al§f.",
				"§r§fSpell Type: §3Aura§f.",
				"§r§fA talisman that emits an aura of §9Water§f energy.",
				"§r§fRight-Click to activate the item.", 
				"§r§fEmit a continual burst of water,", 
				"§r§fpushing those around the caster away and slowing them.",
				"§r§fLasts for 10 seconds outside of range.",
				"§r§fEffective range: 10 meters.",
